...
def get_similar_players(fifa, player_name):
    ...
    normalized_data = normalized_data.drop(columns=['Age', 'Nationality', 'Club', 'Value',
                                                    'Wage', 'Joined', 'Release Clause', 'Height', 'Weight', 'Name',
                                                    'Goalkeeping', 'GK Diving', 'GK Handling',
                                                    'GK Kicking', 'GK Positioning', 'GK Reflexes', 'Player Photo',
                                                    'Club Logo', 'Flag Photo', 'ID', 'OVA', 'BOV',
                                                    'BP', 'Position', 'POT', 'Team & Contract', 'foot', 'Growth',
                                                    'Loan Date End', 'Contract', 'W/F', 'SM', 'A/W',
                                                    'D/W', 'IR', 'PAC', 'SHO', 'PAS', 'DRI', 'DEF', 'PHY', 'Hits', 'LS',
                                                    'ST', 'RS', 'LW', 'LF', 'CF', 'RF', 'RW',
                                                    'LAM', 'CAM', 'RAM', 'LM', 'LCM', 'CM', 'RCM', 'RM', 'LWB', 'LDM',
                                                    'CDM', 'RDM', 'RWB', 'LB',
                                                    'LCB', 'CB', 'RCB', 'RB', 'GK', 'Gender', 'Total Stats',
                                                    'Base Stats', 'Vision'
                                                    ], axis=1)
    scaler = MinMaxScaler()
