...
def club_overperforming_players(fifa : pd.DataFrame):
    """
...
def highest_potential(fifa: pd.DataFrame):
    ...
    fig=px.scatter(top_pot_play,x='Age',y='POT',size='POT',color='Age',hover_data=['Name','Age','Nationality','BP','OVA','Value','Release Clause'],title='Age vs Maximum Potential Distribution of the young Players')
    return fig
